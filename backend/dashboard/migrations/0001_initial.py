...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            options={
                'indexes': [models.Index(fields=['dates'], name='dashboard_m_dates_820a1e_idx')],
            },
        ),
        migrations.CreateModel(
            name='PlanNumbers',
            fields=[
                ('profile', models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, primary_key=True, serialize=False, to='dashboard.profiles', verbose_name='Профиль')),
            ...
            options={
                ...
                'ordering': ['profile'],
                'indexes': [models.Index(fields=['plan'], name='dashboard_p_plan_d06a14_idx')],
            },
        ),
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('profile', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='dashboard.profiles')),
            ],
            options={
                'indexes': [models.Index(fields=['number'], name='dashboard_a_number_dc1716_idx')],
            },
        ),
    ]
