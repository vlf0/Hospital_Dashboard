...
from .models import MainData, AccumulationOfIncoming, Profiles, MainDataDetails, ChartPlans
...
class ChartPlansSerializer(serializers.ModelSerializer):

    class Meta:
        model = ChartPlans
        fields = ['chart_name', 'plan_value']
