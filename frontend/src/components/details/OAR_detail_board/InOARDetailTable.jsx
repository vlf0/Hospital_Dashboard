...
const oarDetail = [
                      ['Пахомов С.В.', 126, 16, 'ОРИТ №1', 'Климов А.Е.', 'J06.9'],
                      ['Смирнова А.В.', 335, 22, 'ОРИТ №2', 'Молунова В.В.', 'G80.3'],
                      ['Воль О.С.', 224, 75, 'ОРИТ №3', 'Красиков Е.Н.', 'E80.0'],
                      ['Рубак Т.П.', 178, 63, 'ОРИТ №1', 'Быков А.И.', 'K76.2'],
                    ];
