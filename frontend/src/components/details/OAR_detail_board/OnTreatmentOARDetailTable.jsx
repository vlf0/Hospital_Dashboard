...
const oarDetail = [
                    ['Пахомов С.В.', 126, 43, 'ОРИТ №2', 'Климов А.Е.', 3, 'J06.9'],
                    ['Смирнова А.В', 126, 43, 'ОРИТ №1', 'Молунова В.В.', 6, 'G80.3'],
                    ['Воль О.С.', 126, 43, 'ОРИТ №2', 'Красиков Е.Н.', 1, 'E80.0'],
                    ['Рубак Т.П.', 126, 43, 'ОРИТ №3', 'Быков А.И.', 4, 'K76.2'],
                  ];
